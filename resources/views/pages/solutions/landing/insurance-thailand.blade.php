<x-layout title="eKYC for Insurance Industry in Thailand — EMAS eKYC">
    ...
    <section class="bg-primary text-primary-content py-16 sm:py-24">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-lg text-primary-content/80 max-w-2xl mx-auto mb-8">Enhance your insurance onboarding with AI-powered identity verification compliant with OIC and Bank of Thailand regulations.</p>
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 gap-6">
                <div class="card bg-base-200 shadow-sm">
                    <div class="card-body">
                        <h3 class="card-title text-base">OIC Compliance</h3>
                        <p class="text-sm text-base-content/70">Comply with Office of Insurance Commission (OIC) regulations for digital customer onboarding in Thailand's insurance sector.</p>
                    </div>
                </div>
                <div class="card bg-base-200 shadow-sm">
                    <div class="card-body">
                        <h3 class="card-title text-base">PDPA Compliance</h3>
                        <p class="text-sm text-base-content/70">Our solution ensures compliance with Thailand's Personal Data Protection Act (PDPA) for handling policyholder personal data.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-16 bg-base-200">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-base-content/70 mb-8">Talk to our team about implementing eKYC for your Thai insurance operations.</p>
