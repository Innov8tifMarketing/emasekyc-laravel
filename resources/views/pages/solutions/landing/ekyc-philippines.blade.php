<x-layout title="eKYC Philippines — EMAS eKYC">
    ...
    <section class="bg-primary text-primary-foreground py-16 sm:py-24">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-lg text-primary-foreground/80 max-w-2xl mx-auto mb-8">AI-powered identity verification for real-time digital customer onboarding and fraud management in the Philippines.</p>
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="text-center">
                    ...
                    <p class="text-sm text-muted-foreground">Capture and verify Philippine national ID, passport, driver's license, and other government-issued IDs.</p>
                </div>
                <div class="text-center">
                    ...
                    <p class="text-sm text-muted-foreground">Compliant with BSP (Bangko Sentral ng Pilipinas) eKYC regulations and anti-money laundering requirements.</p>
                </div>
                <div class="text-center">
                    ...
                    <p class="text-sm text-muted-foreground">Real-time identity verification with results in seconds, not days.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="grid md:grid-cols-3 gap-6">
                <div class="rounded-xl border border-border bg-background shadow-sm">
                    <div class="p-6 flex flex-col gap-2">
                        ...
                        <p class="text-sm text-muted-foreground">Local office in Makati City with dedicated support for Philippine clients.</p>
                    </div>
                </div>
                <div class="rounded-xl border border-border bg-background shadow-sm">
                    <div class="p-6 flex flex-col gap-2">
                        <h3 class="font-semibold leading-none tracking-tight text-base">Proprietary Technology</h3>
                        <p class="text-sm text-muted-foreground">AI technology trained on Philippine identity documents for high accuracy verification.</p>
                    </div>
                </div>
                <div class="rounded-xl border border-border bg-background shadow-sm">
                    <div class="p-6 flex flex-col gap-2">
                        <h3 class="font-semibold leading-none tracking-tight text-base">Flexibility in Deployment</h3>
                        <p class="text-sm text-muted-foreground">Cloud, on-premise, or hybrid deployment options to meet your compliance needs.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-16">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-muted-foreground mb-8">Talk to our Philippines team about implementing eKYC for your business.</p>
