<x-layout title="Cambodia Banking Whitepaper — EMAS eKYC">
    ...
    <section class="bg-primary text-primary-content py-16 sm:py-24">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-lg text-primary-content/80 max-w-2xl mx-auto mb-8">An in-depth look at digital identity verification in Cambodia's rapidly evolving banking and financial services sector.</p>
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="/contact" class="btn btn-secondary">Download Whitepaper</a>
    ...
    <section class="py-16">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-base-content/70 mb-8">Contact us to receive the complete Cambodia Banking Whitepaper.</p>
