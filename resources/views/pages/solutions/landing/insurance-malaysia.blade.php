<x-layout title="eKYC for Insurance Industry in Malaysia — EMAS eKYC">
    ...
    <section class="bg-primary text-primary-foreground py-16 sm:py-24">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-lg text-primary-foreground/80 max-w-2xl mx-auto mb-8">Enhance your insurance onboarding with AI-powered identity verification compliant with Bank Negara Malaysia (BNM) guidelines.</p>
            ...
            <div class="grid md:grid-cols-2 gap-6">
                <div class="rounded-xl border border-border bg-muted shadow-sm">
                    <div class="p-6 flex flex-col gap-2">
                        <h3 class="font-semibold leading-none tracking-tight text-base">BNM eKYC Policy</h3>
                        <p class="text-sm text-muted-foreground">Comply with Bank Negara Malaysia's eKYC policy document that enables remote customer onboarding for licensed financial institutions including insurers and takaful operators.</p>
                    </div>
                </div>
                <div class="rounded-xl border border-border bg-muted shadow-sm">
                    <div class="p-6 flex flex-col gap-2">
                        <h3 class="font-semibold leading-none tracking-tight text-base">PDPA Compliance</h3>
                        <p class="text-sm text-muted-foreground">Our solution ensures compliance with Malaysia's Personal Data Protection Act 2010 for handling policyholder personal data.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-16 bg-muted">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-muted-foreground mb-8">Talk to our team about implementing eKYC for your Malaysian insurance operations.</p>
