<x-layout title="eKYC Hong Kong — EMAS eKYC">
    {{-- Hero --}}
    <section class="bg-primary text-primary-foreground py-16 sm:py-24">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-lg text-primary-foreground/80 max-w-2xl mx-auto mb-8">AI-powered identity verification technology for real-time digital customer onboarding and fraud management in Hong Kong.</p>
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="text-center">
                    ...
                    <p class="text-sm text-muted-foreground">Users photograph their HKID card or passport using their device camera.</p>
                </div>
                <div class="text-center">
                    ...
                    <p class="text-sm text-muted-foreground">AI-powered facial matching with liveness detection to prevent identity spoofing.</p>
                </div>
                <div class="text-center">
                    ...
                    <p class="text-sm text-muted-foreground">Real-time identity verification compliant with HKMA (Hong Kong Monetary Authority) guidelines.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-muted">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-wrap justify-center gap-3">
                @foreach(['HKID Card', 'HKID (Smart Card)', 'Passport', 'Travel Document'] as $doc)
    ...
    <section class="py-16">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
                @foreach(['Banking & Finance', 'Virtual Banking', 'Insurance', 'Securities & Brokerage', 'Fintech', 'Digital Services'] as $industry)
            ...
            <div class="grid md:grid-cols-3 gap-6">
                <div class="rounded-xl border border-border bg-background shadow-sm">
                    <div class="p-6 flex flex-col gap-2">
                        <h3 class="font-semibold leading-none tracking-tight text-base">ASEAN & Asia-Pacific Presence</h3>
                        <p class="text-sm text-muted-foreground">Regional support with familiarity in Hong Kong's regulatory landscape including HKMA and SFC requirements.</p>
                    </div>
                </div>
                <div class="rounded-xl border border-border bg-background shadow-sm">
                    <div class="p-6 flex flex-col gap-2">
                        <h3 class="font-semibold leading-none tracking-tight text-base">Proprietary Technology</h3>
                        <p class="text-sm text-muted-foreground">AI technology optimised for HKID smart cards with both English and Chinese character recognition.</p>
                    </div>
                </div>
                <div class="rounded-xl border border-border bg-background shadow-sm">
                    <div class="p-6 flex flex-col gap-2">
                        <h3 class="font-semibold leading-none tracking-tight text-base">Flexibility in Deployment</h3>
                        <p class="text-sm text-muted-foreground">Cloud, on-premise, or hybrid deployment to meet Hong Kong's data privacy and security requirements.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-16">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 class="text-2xl font-semibold tracking-tight mb-4">Ready to streamline your customer onboarding in Hong Kong?</h2>
            <p class="text-muted-foreground mb-8">Talk to our team about implementing eKYC for your Hong Kong operations.</p>
