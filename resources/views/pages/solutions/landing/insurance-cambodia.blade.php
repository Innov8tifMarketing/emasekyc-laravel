<x-layout title="eKYC for Insurance Industry in Cambodia — EMAS eKYC">
    ...
    <section class="bg-primary text-primary-foreground py-16 sm:py-24">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-lg text-primary-foreground/80 max-w-2xl mx-auto mb-8">Enhance your insurance onboarding with AI-powered identity verification for the growing Cambodian insurance market.</p>
            ...
            <div class="grid md:grid-cols-2 gap-6">
                <div class="rounded-xl border border-border bg-muted shadow-sm">
                    <div class="p-6 flex flex-col gap-2">
                        <h3 class="font-semibold leading-none tracking-tight text-base">IRC Compliance</h3>
                        <p class="text-sm text-muted-foreground">Comply with Insurance Regulator of Cambodia (IRC) requirements for customer identification and onboarding.</p>
                    </div>
                </div>
                <div class="rounded-xl border border-border bg-muted shadow-sm">
                    <div class="p-6 flex flex-col gap-2">
                        <h3 class="font-semibold leading-none tracking-tight text-base">NBC Guidelines</h3>
                        <p class="text-sm text-muted-foreground">Aligned with National Bank of Cambodia guidelines on digital identity verification and AML requirements.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-16 bg-muted">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-muted-foreground mb-8">Talk to our team about implementing eKYC for your Cambodian insurance operations.</p>
