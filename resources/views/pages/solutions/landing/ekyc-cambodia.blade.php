<x-layout title="eKYC Cambodia — EMAS eKYC">
    {{-- Hero --}}
    <section class="bg-primary text-primary-foreground py-16 sm:py-24">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-lg text-primary-foreground/80 max-w-2xl mx-auto mb-8">AI-powered identity verification technology for real-time digital customer onboarding and fraud management in Cambodia.</p>
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="text-center">
                    ...
                    <p class="text-sm text-muted-foreground">Users photograph their Cambodian National ID or passport using their device camera.</p>
                </div>
                <div class="text-center">
                ...
                <div class="text-center">
                    ...
                    <p class="text-sm text-muted-foreground">Real-time identity verification compliant with NBC (National Bank of Cambodia) requirements.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
                @foreach(['Banking & Finance', 'Microfinance', 'Insurance', 'Telecommunication', 'Digital Payments', 'Government'] as $industry)
            ...
            <div class="grid md:grid-cols-3 gap-6">
                <div class="rounded-xl border border-border bg-background shadow-sm">
                    <div class="p-6 flex flex-col gap-2">
                        <h3 class="font-semibold leading-none tracking-tight text-base">Local Presence in Cambodia</h3>
                        <p class="text-sm text-muted-foreground">Office in Phnom Penh with local support teams familiar with Cambodian banking and regulatory requirements.</p>
                    </div>
                </div>
                <div class="rounded-xl border border-border bg-background shadow-sm">
                    <div class="p-6 flex flex-col gap-2">
                        <h3 class="font-semibold leading-none tracking-tight text-base">Proprietary Technology</h3>
                        <p class="text-sm text-muted-foreground">AI technology optimised for Cambodian identity documents with Khmer script recognition.</p>
                    </div>
                </div>
                <div class="rounded-xl border border-border bg-background shadow-sm">
                    <div class="p-6 flex flex-col gap-2">
    ...
    <section class="py-16">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 class="text-2xl font-semibold tracking-tight mb-4">Ready to streamline your customer onboarding in Cambodia?</h2>
            <p class="text-muted-foreground mb-8">Talk to our team about implementing eKYC for your Cambodian operations.</p>
