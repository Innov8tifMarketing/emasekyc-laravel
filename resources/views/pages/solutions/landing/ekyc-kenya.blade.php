<x-layout title="eKYC Kenya — EMAS eKYC">
    ...
    <section class="bg-primary text-primary-foreground py-16 sm:py-24">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-lg text-primary-foreground/80 max-w-2xl mx-auto mb-8">AI-powered identity verification technology for real-time digital customer onboarding and fraud management in Kenya.</p>
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="text-center">
                    ...
                    <p class="text-sm text-muted-foreground">Users photograph their Kenyan National ID (Huduma Namba) or passport using their device.</p>
                </div>
                <div class="text-center">
                ...
                <div class="text-center">
                    ...
                    <p class="text-sm text-muted-foreground">Real-time identity verification compliant with CBK (Central Bank of Kenya) requirements.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="grid md:grid-cols-3 gap-6">
                <div class="rounded-xl border border-border bg-background shadow-sm">
                    <div class="p-6 flex flex-col gap-2">
                        <h3 class="font-semibold leading-none tracking-tight text-base">Expanding into Africa</h3>
                        <p class="text-sm text-muted-foreground">Extending our proven ASEAN technology to serve the growing East African digital economy.</p>
                    </div>
                </div>
                <div class="rounded-xl border border-border bg-background shadow-sm">
                    <div class="p-6 flex flex-col gap-2">
                        <h3 class="font-semibold leading-none tracking-tight text-base">Proprietary Technology</h3>
                        <p class="text-sm text-muted-foreground">AI technology trained on diverse populations with high accuracy across varying skin tones and document types.</p>
                    </div>
                </div>
                <div class="rounded-xl border border-border bg-background shadow-sm">
                    <div class="p-6 flex flex-col gap-2">
                        <h3 class="font-semibold leading-none tracking-tight text-base">Flexibility in Deployment</h3>
                        <p class="text-sm text-muted-foreground">Cloud, on-premise, or hybrid deployment to meet Kenya's Data Protection Act requirements.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-16">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-muted-foreground mb-8">Talk to our team about implementing eKYC for your Kenyan operations.</p>
