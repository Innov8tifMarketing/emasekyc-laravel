<x-layout title="eKYC Brunei — EMAS eKYC">
    ...
    <section class="bg-primary text-primary-content py-16 sm:py-24">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-lg text-primary-content/80 max-w-2xl mx-auto mb-8">AI-powered identity verification technology for real-time digital customer onboarding and fraud management in Brunei Darussalam.</p>
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="text-center">
                    ...
                    <p class="text-sm text-base-content/70">Users photograph their Brunei Identity Card (BN-IC) or passport using their device.</p>
                </div>
                <div class="text-center">
                ...
                <div class="text-center">
                    ...
                    <p class="text-sm text-base-content/70">Real-time identity verification compliant with AMBD (Autoriti Monetari Brunei Darussalam) requirements.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="grid md:grid-cols-3 gap-6">
                <div class="card bg-base-100 shadow-sm">
                    <div class="card-body">
                        ...
                        <p class="text-sm text-base-content/70">Regional support with familiarity in Brunei's regulatory and Syariah-compliant financial landscape.</p>
                    </div>
                </div>
                <div class="card bg-base-100 shadow-sm">
                    <div class="card-body">
                        <h3 class="card-title text-base">Proprietary Technology</h3>
                        <p class="text-sm text-base-content/70">AI technology optimised for Bruneian identity documents with Jawi and Latin script recognition.</p>
                    </div>
                </div>
                <div class="card bg-base-100 shadow-sm">
                    <div class="card-body">
    ...
    <section class="py-16">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-base-content/70 mb-8">Talk to our team about implementing eKYC for your Bruneian operations.</p>
