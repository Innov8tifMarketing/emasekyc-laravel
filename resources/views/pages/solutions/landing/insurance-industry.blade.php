<x-layout title="eKYC for Insurance Industry — EMAS eKYC">
    ...
    <section class="bg-primary text-primary-content py-16 sm:py-24">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-lg text-primary-content/80 max-w-2xl mx-auto mb-8">Transform your insurance onboarding with AI-powered identity verification. Reduce fraud, streamline claims, and improve customer experience across ASEAN.</p>
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-6">
                <div class="card bg-base-200 shadow-sm">
                    <div class="card-body">
                        <h3 class="card-title text-base">Identity Fraud</h3>
                        <p class="text-sm text-base-content/70">Fraudulent claims and synthetic identities cost the insurance industry billions annually across Southeast Asia.</p>
                    </div>
                </div>
                <div class="card bg-base-200 shadow-sm">
                    <div class="card-body">
                        <h3 class="card-title text-base">Slow Onboarding</h3>
                        <p class="text-sm text-base-content/70">Manual document review and in-person verification create friction that leads to customer drop-off.</p>
                    </div>
                </div>
                <div class="card bg-base-200 shadow-sm">
                    <div class="card-body">
                        <h3 class="card-title text-base">Regulatory Compliance</h3>
                        <p class="text-sm text-base-content/70">Varying KYC and AML requirements across ASEAN markets make compliance complex and costly.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
                @foreach([
                    ...
                    <a href="{{ $url }}" class="card bg-base-200 shadow-sm hover:shadow-md transition">
    ...
    <section class="py-16 bg-base-200">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-base-content/70 mb-8">Talk to our team about implementing eKYC for your insurance operations.</p>
