...
<div class="mt-8 border-t border-base-300 pt-6" x-data="wikiFeedback()">
    <template x-if="!submitted">
        <div class="flex items-center gap-4">
            <span class="text-sm text-base-content/70">Was this page helpful?</span>
            <button @click="submit(true)" class="btn btn-sm btn-ghost">
            ...
            <button @click="submit(false)" class="btn btn-sm btn-ghost">
