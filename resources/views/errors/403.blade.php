<x-layout title="Access Denied — EMAS eKYC">
    <section class="py-24 sm:py-32 bg-muted">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="rounded-xl border border-border bg-background p-8 sm:p-10">
                <p class="text-7xl font-bold text-destructive mb-6">403</p>
                <h1 class="text-3xl sm:text-4xl font-semibold tracking-tight mb-3">Access denied</h1>
                <p class="text-lg text-muted-foreground mb-10">You don't have permission to view this page.</p>

                <div class="border-t border-border pt-6 mb-8">
                    <p class="text-sm font-semibold uppercase tracking-wider text-muted-foreground mb-4">Try these instead</p>
